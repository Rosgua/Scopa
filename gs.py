...
class GameSystem:
    ...
    def calculate_primiera(self,player):
        primiera_values = {7: 21, 6: 18, 1: 16, 5: 15, 4: 14, 3: 13, 2: 12, 10: 10, 9: 10, 8: 10}
        ...
        punteggio_tot= sum(primiera_values[c.number] for c in best_by_suit.values())
    ...
    def endGame(self):
        ...
        return f"""
            score {self.Hplayer.username}: {self.Hplayer.score},
            ai_score: {self.playerAI.score},
            winner:  {winner} !"""
...
class TurnManager(Subject):
    ...
    def getCurrentPlayer(self):
        return self.observers[self.currentPlayerIndex -1] # 1 = Human, 2 = AI
